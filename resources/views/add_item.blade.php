                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{ url('item/page_add') }}">Create Item</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <br/>
                                                <input type="checkbox" id="select_taxable" name="select_taxable" style="width: 30px; height: 30px;" value="1">
                                            </div>
                                        </div>
