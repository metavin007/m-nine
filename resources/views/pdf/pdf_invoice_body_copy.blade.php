    ...
    <header>
        ...
        <table>      
            <tr>
                ...
                <td style="width: 10px;"><div style="color:#000000; font-size: 20px; line-height: 60%;"><b>:</b></div></td>
                <td><div style="color:#000000; font-size: 20px; line-height: 60%;"><span class="page-number"></span></div></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3" rowspan="4"><div style="color:#000000; font-size: 20px; line-height: 60%;">{!! $invoice->customer->company_name_eng . '<br/>' . $invoice->customer->address_eng !!}</div></td>
