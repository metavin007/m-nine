...
<table>      
    <tr>
        <td style="font-size: 24px; color:#000000; text-align: center;"><b>สำเนา ใบแจ้งหนี้/INVOICE</b></td>
    </tr>
</table>
...
<table>      
    <tr>
        ...
        <td style="width: 200px;"><div style="color:#000000; font-size: 20px; line-height: 60%;"><b>Page No</b></div></td>
        <td style="width: 10px;"><div style="color:#000000; font-size: 20px; line-height: 60%;"><b>:</b></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;">{{ '1' }}</div></td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="3"><div style="color:#000000; font-size: 20px; line-height: 60%;">{{ $invoice->customer->company_name_eng }}</div></td>
    ...
    <tr>
        <td colspan="3" rowspan="3"><div style="color:#000000; font-size: 20px; line-height: 60%;">{!! $invoice->customer->address_eng !!}</div></td>
    ...
    <tr>
        <td colspan="5"><div style="color:#002060; font-size: 20px; line-height: 60%;"><b></b></div></td>
    </tr>
    <tr>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;"><b></b></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;"><b></b></div></td>
...
<table style="margin-top: 10px; border: 1px solid; border-collapse: collapse; border-left: none; border-right: none; border-bottom: none;">  
    ...
    <tr>
        ...
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;" align="right">{{ number_format($invoice->non_taxable_total,2) }}</div></td>
    </tr>
    <tr>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;"></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;"></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;" align="right"><b>Taxable Total</b></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;" align="right">{{ number_format($invoice->taxable_total,2) }}</div></td>
    </tr>
    <tr>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;"></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;"></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;" align="right"><b>Total Amount</b></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;" align="right">{{ number_format($invoice->total_amount,2) }}</div></td>
    </tr>
    <tr>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;"></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;"></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;" align="right"><b>VAT 7%</b></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;" align="right">{{ number_format($invoice->vat_7,2) }}</div></td>
    </tr>
    <tr>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;"></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;"></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;" align="right"><b>Grand Total</b></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;" align="right">{{ number_format($invoice->grand_total,2) }}</div></td>
    </tr>
    <tr>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;"></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;"></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;" align="right"><b>With Holding Tax {{ $invoice->with_holding_tax }} %</b></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;" align="right">{{ number_format($invoice->with_holding_tax_3,2) }}</div></td>
    </tr>
    <tr>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;"></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;"></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;" align="right"><b>Tatal Invoiced THB</b></div></td>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;" align="right">{{ number_format($invoice->total_invioced_thb,2) }}</div></td>
    </tr>

    <tr>
        <td colspan="4"><div style="color:#000000; font-size: 20px; line-height: 60%;" align="left"><b>AMOUNT : {{ $invoice->amount }}</b></div></td>
    </tr>
</table>
...
<table>  
    <tr>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;">* Please issue a crossed Cheque "A/C Payee Only" to " M-NINE (THAILAND) Limited."</div></td>
    </tr>
    <tr>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;">* If you have any queries on the items mentioned herein, please notify within 7 days</div></td>
    </tr>
    <tr>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;">* An interrest fee of 2% per month will be charged on your balance outstanding overdue.</div></td>
    </tr>
    <tr>
        <td><div style="color:#000000; font-size: 20px; line-height: 60%;">* Invoice due date is counted from invoice date.</div></td>
    </tr>
</table>