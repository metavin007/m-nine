    ...
    <header>
        ...
        <table> 
            ...
            <tr>
                ...
                <td style="width: 180px;"><div style="color:#002060; font-size: 20px; line-height: 60%;"><b>Description of Goods</b></div></td>
            ...
            <tr>
                ...
                <td><div style="color:#002060; font-size: 20px; line-height: 60%;">{{ $invoice->description_of_goods1 }}</div></td>
                <td><div style="color:#002060; font-size: 20px; line-height: 60%;">{{ $invoice->no_of_packages1 . ' Packages' }}</div></td>
                <td><div style="color:#002060; font-size: 20px; line-height: 60%;">{{ $invoice->act_weight . ' KGM'}}</div></td>
                <td><div style="color:#002060; font-size: 20px; line-height: 60%;">{{ $invoice->volume . ' CBM'}}</div></td>
            </tr>
            <tr>
                <td><div style="color:#002060; font-size: 20px; line-height: 60%;">{{ $invoice->mark_and_numbers2 }}</div></td>
                <td><div style="color:#002060; font-size: 20px; line-height: 60%;">{{ $invoice->description_of_goods2 }}</div></td>
                <td><div style="color:#002060; font-size: 20px; line-height: 60%;">{{ $invoice->no_of_packages2 }}</div></td>
                <td><div style="color:#002060; font-size: 20px; line-height: 60%;"></div></td>
                <td><div style="color:#002060; font-size: 20px; line-height: 60%;"></div></td>
            </tr>
        </table>
    ...
    <footer>
        <table>  
            ...
            <tr>
                ...
                <td><div style="color:#002060; font-size: 20px; line-height: 60%;"><b></b></div></td>
                <td align="center"><div style="color:#002060; font-size: 20px; line-height: 60%;"><b>Invoice Received By</b></div></td>
                <td align="center"><div style="color:#002060; font-size: 20px; line-height: 60%;"><b>Date</b></div></td>
            </tr>
        </table>
        <br/>
        ...
        foreach ($details as $key => $value) {
            ...
            if (($key % $limit_page) == 0) {
                ...
                <table style="margin-top: 10px; border: 1px solid; border-collapse: collapse; border-left: none; border-right: none; border-bottom: none;">  
                    ...
                    <tr>
                        <td><div style="color:#002060; font-size: 20px; line-height: 60%;">{{ $invoice_detail->item->code }}</div></td>
                        <td><div style="color:#002060; font-size: 20px; line-height: 60%;">{{ $invoice_detail->item->particulars }}</div></td>
                        <td><div style="color:#002060; font-size: 20px; line-height: 60%;" align="right">{{ ($invoice_detail->select_taxable == 0 ? number_format($invoice_detail->amount,2) : '') }}</div></td>
                        <td><div style="color:#002060; font-size: 20px; line-height: 60%;" align="right">{{ ($invoice_detail->select_taxable == 1 ? number_format($invoice_detail->amount,2) : '') }}</div></td>
                    </tr>
                    @endforeach
                    <tr>
