...
<body>
    ...
    <header>
        <table>
            <tr>
                ...
                <td style="width: 90%;">
                    <div style="color:#1566a1; font-size: 26px; line-height: 60%;"><b>{{ $mycompany->name_th }}</b></div>
                    <div style="color:#1566a1; font-size: 20px; line-height: 60%;"><b>{{ $mycompany->name_en }}</b></div>
                    <div style="color:#1566a1; font-size: 18px; line-height: 30%; color: white;"><b>x</b></div>
                    <div style="color:#002060; font-size: 15px; line-height: 60%;"><b>{{ $mycompany->address_th . ' ' }} Tel :  {{ $mycompany->tel }}</b></div>
                    <div style="color:#002060; font-size: 15px; line-height: 60%;"><b>{{ $mycompany->address_en . ' ' }} Tel :  {{ $mycompany->tel }}</b></div>
                    <div style="color:#002060; font-size: 15px; line-height: 60%;"><b>เลขประจำตัวผู้เสียภาษีอากร/TAX ID NO.: {{ $mycompany->tax_id_no }}</b></div>
                </td>
            </tr>
        </table>
    ...
    <footer>
        <table>
            <tr>
                <td><div style="color:#002060; font-size: 20px; line-height: 60%; border-bottom: 1px solid;"><b></b></div></td>
                <td><div style="color:#002060; font-size: 20px; line-height: 60%; border-bottom: 1px solid;"><b></b></div></td>
                <td><div style="color:#002060; font-size: 20px; line-height: 60%; border-bottom: 1px solid;"><b></b></div></td>
            </tr>
            <tr>
                <td align="center"><div style="color:#002060; font-size: 20px; line-height: 60%;"><b>ผู้รับเอกสาร</b></div></td>
                <td align="center"><div style="color:#002060; font-size: 20px; line-height: 60%;"><b>ผู้รับเงิน</b></div></td>
                <td align="center"><div style="color:#002060; font-size: 20px; line-height: 60%;"><b>ลายมือชื่อผู้ที่ได้รับมอบอำนาจ</b></div></td>
            </tr>
            <tr>
                <td align="center"><div style="color:#002060; font-size: 20px; line-height: 60%;"><b>RECEIVED BY</b></div></td>
                <td align="center"><div style="color:#002060; font-size: 20px; line-height: 60%;"><b>COLLECTOR</b></div></td>
        ...
        <table>
            <tr>
                <td style="width: 50px;"><div style="color:#002060; font-size: 16px; line-height: 60%;"><u>คำเตือน</u></div></td>
                <td><div style="color:#002060; font-size: 16px; line-height: 60%;">กรุณาตรวจสอบความถูกต้องของเอกสารที่ได้รับ หากมีการแก้ไข ขอให้แจ้งบริษัทฯ ทันที ภายใน 7 วัน มิฉะนั้น บริษัทฯ จะถือว่าเอกสารฉบับนี้สมบูรณ์แล้ว</div></td>
            </tr>
        </table>
        ...
        foreach ($details as $key => $value) {
            ...
            if (($key % $limit_page) == 0) {
                ...
                <table style="margin-top: 10px; width: 100%; border: 1px solid; border-collapse: collapse; border-left: none; border-bottom: none;">
                    ...
                    <tr>
                        <td style="border-left: 1px solid; border-right: 1px solid;" colspan="2"><div style="color:#002060; font-size: 20px; line-height: 60%;">{{ $receipt_detail->invoice->invoice_number . ' - ' . $receipt_detail->invoice->house_way_number }}</div></td>
                        <td style="border-left: 1px solid; border-right: 1px solid;"><div style="color:#002060; font-size: 20px; line-height: 60%;" align="right">{{ number_format($receipt_detail->invoice->non_taxable_total,2) }}</div></td>
                        <td><div style="color:#002060; font-size: 20px; line-height: 100%;" align="right">{{ number_format($receipt_detail->invoice->taxable_total,2) }}</div></td>
                    </tr>
                    @endforeach
                    <tr>
                ...
                <table>
                    <tr>
                        <td style="font-size: 20px; color:#002060; text-align: left;"><b>ได้รับเงินแล้ว</b></td>
                    </tr>
                </table>
                @endif
                ...
                <table>
                    <tr>
                        <td style="font-size: 20px; color:#002060; text-align: left;"><b>{{ ' - ' . $receipt->payment_type }}</b></td>
                    </tr>
                </table>
                @endif
                ...
                <table>
                    <tr>
                        <td style="font-size: 20px; color:#002060; text-align: left;"><b>{{ ' - ' . $receipt->payment_type . ' NO. ' . $receipt->check_no . ' Date ' . $receipt->check_date }}</b></td>
                    </tr>
                </table>
                @endif
