                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{ url('invoice/page_add') }}">Create Invoice</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form id="FormAdd">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-4 col-4">
                                                    <input id="customer_tax_id_no" type="text" class="form-control"  readonly=""> 
                                                </div>
                                                <div class="col-lg-4 col-4">
                                                    <input  id="branch" type="text" class="form-control"  readonly="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-8">
                                                    <input name="invoice_number" value="<?PHP
                                                    $year = date("y", time());
                                                    $month = date("m", time());
                                                    echo "IV" . $year . $month . "-" . sprintf("%03d", $code);
                                                    ?>" type="text" placeholder="" class="form-control text-right"  readonly=""> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input id="customer_address" type="text" class="form-control"  readonly="">   
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row align-items-center">
                                                <div class="col-lg-4 col-4">
                                                ...
                                                <div class="col-lg-8 col-8">
                                                    <input id="due_date" name="due_date" type="text" class="form-control text-right" value="<?php echo date('d-m-Y', time()); ?>" readonly=""> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-8">
                                                    <input  name="our_reference_number" type="text" class="form-control " required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-8">
                                                    <input id="house_way_number" name="house_way_number" type="text" class="form-control"  readonly=""> 
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-8">
                                                    <input name="vessel_date" type="text" class="form-control" required=""> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>  
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-3">
                                            <div class="form-group">
                                                ...
                                                <input id="mark_and_numbers1" name="mark_and_numbers1" type="text" class="form-control"  required=""> 
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-3">
                                            <div class="form-group">
                                                <label for="code">Description of Goods :(ช่อง 1:52 ตัว 2:26 ตัว)</label>
                                                <input name="description_of_goods1" type="text" class="form-control"> 
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input name="no_of_packages1" type="text" maxlength="52" class="form-control">
                                        ...
                                        <div class="col-lg-2 col-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input name="act_weight" type="text" class="form-control"> 
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-3">
                                            <div class="form-group">
                                                <input  name="mark_and_numbers2" type="text" class="form-control"> 
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-3">
                                            <div class="form-group">
                                                <input  name="description_of_goods2" type="text" maxlength="26" class="form-control"> 
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-2">
                                            <div class="form-group">
                                                <div class="input-group mb-3">
                                                    <input  name="no_of_packages2" type="text" class="form-control" > 
                                                    <span class="input-group-text">Packages</span>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tfoot>
                                                        <tr class="text-center">
                                                            <td><button type="button" class="btn btn-info btn_add_item" disabled="">Add Item</button></td>
                                                            <td colspan="4"></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-8">
                                                    <input id="non_taxable_total" name="non_taxable_total" type="text" placeholder="" class="form-control text-right" readonly=""> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>  
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-8">
                                                    <input id="taxable_total"  name="taxable_total" type="text" class="form-control text-right" readonly=""> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-8">
                                                    <input id="total_amount" name="total_amount" type="text" class="form-control text-right" readonly=""> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-8">
                                                    <input id="vat_7" name="vat_7" type="text" class="form-control text-right" readonly=""> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-8">
                                                    <input id="grand_total" name="grand_total" type="text" class="form-control text-right" readonly=""> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-lg-8 col-8">
                                                    <div class="form-group">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input id="with_holding_tax_3" name="with_holding_tax_3" type="text" class="form-control text-right" readonly=""> 
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-8">
                                                    <input id="total_invioced_thb" name="total_invioced_thb" type="text" class="form-control text-right" readonly=""> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-2 col-2">
                                                    <input id="costs" name="costs" type="number" step="any" class="form-control text-right" required=""> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    $('body').on('change', '#customer_id', function (e) {
        ...
        $.ajax({
            ...
            $('#body_item').html('');
            $.each(rec['items'], function (index, value) {
                var check_select_taxable = "";
                if (value.item.select_taxable == 1) {
                    check_select_taxable = "checked";
                }
                var btn_delete = '<td class="text-center"><button class="btn btn-danger btn_delete_item">Delete</button></td>';
                var code = '<td><input type="text" class="form-control" value="' + value.item.code + '" readonly=""><input type="hidden" class="form-control" name="select_item[' + index_item + '][item_id]" value="' + value.item_id + '" readonly=""></td>';
                var particulars = '<td><input type="text" class="form-control" value="' + value.item.particulars + '" readonly=""></td>';
                var amount = '<td class="text-center"><input onchange="calcurate();" class="form-control text-right amount" name="select_item[' + index_item + '][amount]" type="number" value="' + value.amount + '" title="กรุณาระบุ" required=""></td>';
                var select_taxable = '<td class="text-center"><input class="select_taxable" onchange="calcurate();" name="select_item[' + index_item + '][select_taxable]" style="width: 30px; height: 30px;" type="checkbox" value="1" ' + check_select_taxable + '> vat</td>';
