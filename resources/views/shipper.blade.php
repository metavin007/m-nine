            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active"><a href="{{ route('shipper') }}">Shipper</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="section">
            ...
            <div class="card">
                <div class="card-header" style="text-align: right;">
                    <a href="{{ url('shipper/page_add') }}" class="btn btn-primary">Add</a>
                </div>
                <div class="card-body">
...
<script>
    ...
    var TableList = $('#table_list').dataTable({
        ...
        "ajax": {
            "url": url_gb + "/shipper/get_datatable",
            "data": function (d) {
                //d.myKey = "myValue";
        ...
        "columns": [
            ...
            {"data": "ori", "className": "text-left"},
            {"data": "dest", "className": "text-left"},
